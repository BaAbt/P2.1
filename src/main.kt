...
fun main() {
    ...
    //teste Dynamische Liste
    println("\nDynamische Liste Test")
    val dynPlaylist = DynamicPlaylist(arrayListOf(song[0],song[1],song[2]))
    dynPlaylist.spieleAlle()
    dynPlaylist.songEntnehmen()
    dynPlaylist.spieleAlle()
    dynPlaylist.zuruecksetzen()
    dynPlaylist.spieleAlle()
    readLine()
